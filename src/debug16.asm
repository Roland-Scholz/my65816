...
; .ORG $A00
DIRPAGE		equ $0000          ; LOCATION OF THIS APPLICATION’S
...
;		INY
		...
		JSR printhex             ; FORM AS HEX STRING IN
		LDA OPCREG             ; LINE
		JSR printhex
		jsr space
...
MORE1:		LDA OPRNDL,X     		; LOOP THROUGH OPERAND
		JSR printhex			; HIGH TO LOW
		DEX
		BPL MORE1
		RTS
...
OVL		equ	$40				; MASK FOR OVERFLOW FLAG
...
LDYI		equ	$A0           ; OPCODE VALUE TIMES TWO
LDXI		equ	$A2
CPYI		equ	$C0
CPXI		equ	$E0
REPI		equ	$C2
...
;		jsr	printhex
		...
		bmi	OK1		; NUMBER WAS NEGATIVE; ALL IS OK
