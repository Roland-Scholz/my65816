...
#define SCRBASE 0xFFB000UL

static char *scrptr = (char *)SCRBASE;
static unsigned int xpos = 0, ypos = 0;

static computeXY() {
	scrptr = (char *)(SCRBASE + xpos + ypos * 80);
}

static void scrolup() {
	memcpy(scrptr - 80UL, scrptr, 1920UL);
	scrptr = (char *)(SCRBASE + 1920UL);
	memset(scrptr, 0, 80UL);
}
