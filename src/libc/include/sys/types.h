...
#if defined (__65816__) || defined(__alpha__) || defined(__ia64__) || defined(__sparc64__) || defined(__s390x__) || defined(__aarch64__)
...
/* non-susv2 types: */
__extension__ typedef double loff_t;	/* 64-bit offset */

__extension__ typedef double off64_t;
...
__extension__ typedef double ino64_t;
__extension__ typedef double blkcnt64_t;
